              ...
              child: Row(
                ...
                children: [
                  Text(
                    ...
                    style: AppStyles.poppins14w400darkGrey2.copyWith(
                  ...
                  isOpen
                      ...
                      : SvgPicture.asset(AppSvgs.arrowDownSvg),
                ],
              ),
            ),
          ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text("Date Of Birth".tr, style: AppStyles.poppins12w600darkGrey2),
          10.verticalSpace,
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Expanded(
                child: Obx(
                  () => DateOfBirthDropDown(
                    ...
                    onTap: () => controller.isDayDropdownOpen.toggle(),
                    items: List.generate(
                      31,
              ...
              Expanded(
                child: Obx(
                  () => DateOfBirthDropDown(
                    ...
                    onTap: () => controller.isMonthDropdownOpen.toggle(),
                    items: List.generate(
                      12,
                      (i) => (i + 1).toString().padLeft(2, '0'),
                    ),
              ...
              Expanded(
                child: Obx(
                  () => DateOfBirthDropDown(
                    ...
                    onTap: () => controller.isYearDropdownOpen.toggle(),
                    items: List.generate(
